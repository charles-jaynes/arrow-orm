...
function Model(name, definition, skipValidation) {
	...
	_.defaults(this, _.pick(definition, ModelFields), {
		...
		disabledActions: [],
		generated: false,
		serialization: Instance.Arrow ? Instance.Arrow.getGlobal().config.serialization : {}
	});
...
Model.prototype.getPrimaryKeyName = function getPrimaryKeyName() {
	return this.metadata && this.metadata.primarykey && this.serialization && this.serialization.exposePrimaryKeyAsId ? this.metadata.primarykey : 'id';
};
